...
class Client extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['num_agce', 'num_typecli', 'code_cli', 'nom_cli', 'prenom_cli', 'local_cli', 'adresse_cli', 'tel_cli', 'mail_cli', 'cel_cli', 'rccm_cli', 'cpte_contr_cli', 'adresse_geo_cli', 'fax_cli', 'flag_cli', 'tva_cli', 'created_at', 'updated_at','taux_remise_cli','ristourne_cli'];
