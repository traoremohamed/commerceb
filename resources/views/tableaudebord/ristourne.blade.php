...
@php($titre='')
@php($soustitre=' historique des ristournes ')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom" style="width: 100%">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('ristourne')}}" method="post"
                        ...
                        <div align="right">
                            ...
                            <?php if (!empty($recherches)){ ?>
                                ...
                                <a class="btn btn-secondary" href="/apercueristourne/{{$date1}}/{{$date2}}/{{$Agence1}}" target="_blank"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <table class="table table-bordered "
                                    ...
                                    <tr>
                                        <td scope="row" colspan="4" ></td>
                                        <td><strong> Montant ritourne</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format($montanttotal - ($montanttotal*(3/100))); ?> FCFA </td>
                                        <td></td>
                                    </tr>
                                    </tbody>
                                </table>
