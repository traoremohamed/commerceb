                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('historiqueproformat') }}" class="text-muted">{{$titre}}</a>
                            </li>
                            <li class="breadcrumb-item">
            ...
            <!--end::Notice-->
                ...
                <div class="card card-custom" style="width: 100%">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('historiqueproformat')}}" method="post"
                            ...
                            <div class="col-lg-12">
                                ...
                                <table class="table table-bordered "
                                    ...
                                    foreach ($recherches as $recherche):
                                        $montanttotal += $recherche->prix_ttc_comc;
                                        $i++;
                                        ?>

                                        <tr>
                                            <td>{{ $i}}</td>
                                            <td>{{ $recherche->num_comc}}</td>
                                            <td>{{ $recherche->nom_cli}} {{ $recherche->prenom_cli}}</td>
                                            <td align="right"><?php echo number_format($recherche->prix_ttc_comc); ?> </td>
                                            <td><?php if ($recherche->flag_comc == true) { ?>
