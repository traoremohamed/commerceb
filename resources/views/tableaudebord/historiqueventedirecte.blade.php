...
@section('content')
    ...
    @php($titre='')
    @php($soustitre=' Historique des  ventes  a la caisse  ')
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('historiqueventedirecte') }}" class="text-muted">{{$titre}}</a>
                            </li>
                            <li class="breadcrumb-item">
            ...
            <!--end::Notice-->
                ...
                <div class="card card-custom" style="width: 100%">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('historiqueventedirecte')}}" method="post"
                            ...
                            <div align="right">
                              ...
                              //  dd($com1);die();
                                ...
                                <a class="btn btn-secondary" href="/apercuehistoriqueventedirecte/{{$date1}}/{{$date2}}" target="_blank"
