                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                            ...
                            @foreach ($Resultat as $key => $res)
                                <tr>
                                    <td>{{ $res->num_sousfam }}</td>
                                    <td>{{ $res->lib_sousfam }}</td>
                                    <td>{{ $res->lib_fam }}</td>
                                    <td align="center">
                                        <?php if($res->flag_sousfam == true){ ?>
                                    ...
                                    <td align="center">
                                        @can($titreRoute.'-edit')
                                            <a href="{{ route($titreRoute.'.edit',$res->num_sousfam) }}"
                                               class="btn btn-warning btn-xs btn-clean btn-icon"
                                               title="Modifier"> <i class="la la-edit"></i> </a>
                                        @endcan
                                      <!--  @can($titreRoute.'-delete')
                                            {!! Form::open(['method' => 'DELETE','route' => [$titreRoute.'.destroy', $res->num_sousfam],'style'=>'display:inline']) !!}
