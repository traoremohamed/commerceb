                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover table-checkable" id="kt_datatable"
                            ...
                            @foreach ($Resultat as $key => $res)
                                <tr>
                                    <td>{{ $res->num_typecli }}</td>
                                    <td>{{ $res->lib_typecli }}</td>
                                    <td align="center">
                                        <?php if($res->flag_typecli == true){ ?>
                                    ...
                                    <td align="center">
                                        @can($titreRoute.'-edit')
                                            <a href="{{ route($titreRoute.'.edit',$res->num_typecli) }}"
                                               class="btn btn-warning btn-xs btn-clean btn-icon"
                                               title="Modifier"> <i class="la la-edit"></i> </a>
                                        @endcan
                                      <!--  @can($titreRoute.'-delete')
                                            {!! Form::open(['method' => 'DELETE','route' => [$titreRoute.'.destroy', $res->num_typecli],'style'=>'display:inline']) !!}
