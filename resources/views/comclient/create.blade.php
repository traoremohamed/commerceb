...
@section('content')
    ...
    @php($soustitre='Nouvelle Proformat client')
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <!--end::Notice-->
                ...
                <div class="card card-custom" style="width: 100%">
                    ...
                    {!! Form::open(  ['route' => ['comclientadd'], 'method' => 'post' ] ) !!}
                    @csrf
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-lg-3">
                                <label>Client :</label>
                                <select name="num_cli"  id="kt_select2_1" required="required" class="form-control">
